...
Item {
    ...
    Image {
        id: backbround
        source: "qrc:/Assets/DrivePage/Widgets/TempCardL.png"
        anchors.fill: parent
    }
    ...
    Image {
        ...
        width: tempMonitorLeft.width * 0.65
        height: tempMonitorLeft.height * 0.28
        anchors {
            top: tempMonitorLeft.top
            left: tempMonitorLeft.left
            topMargin: tempMonitorLeft.height * 0.138
            leftMargin: tempMonitorLeft.width * 0.28
        }
    ...
    Image {
        ...
        anchors {
            top: tempMonitorLeft.top
            left: tempMonitorLeft.left
            topMargin: tempMonitorLeft.height * 0.587
            leftMargin: tempMonitorLeft.width * 0.28
        }
